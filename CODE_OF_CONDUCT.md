...
confidential report via the repository's **Security** tab ("Report a
vulnerability") or contact the repository owner directly through GitHub. All
...
1. **Correction** — Community Impact: use of inappropriate language or other
   ...
   with clarity around the nature of the violation and an explanation of why the

...
| 1 · Provider layer | [`runbooks/01-litellm-provider-layer.md`](runbooks/01-litellm-provider-layer.md) | LiteLLM abstraction behind the agent client | 🟡 in progress (Comparison done; Advisor next) |

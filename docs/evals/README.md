...
| 3 · Red-team | [`runbooks/03-garak-redteam.md`](runbooks/03-garak-redteam.md) | garak report on the Advisor agent | 🟡 harness built + smoke-tested (`redteam/run_garak.sh`, custom generator injects the real guardrails); full sweep pending |
